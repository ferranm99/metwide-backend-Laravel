...
<body
    ...
    <div
        ...
        Case Study - {{ $caseStudyRequest->caseStudyTitle }}.
    </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font"
                                                                    ...
                                                                    valign="top">Hi {{ $caseStudyRequest->firstName }},<br><br>HThank you and find the attached case study, {{ $caseStudyRequest->caseStudyTitle }}, you requested.<br>
                                                                    <br><br>
                                                                    Kind regards,
                                                                    <br>
