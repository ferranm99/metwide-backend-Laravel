                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font"
                                                                    ...
                                                                    valign="top">Hi Team,<br><br>Here's the new Contact Us Request details.<br>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $contactUsRequest->email }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $contactUsRequest->phone }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $contactUsRequest->subject }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $contactUsRequest->message }}</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="width: 280px; padding: 20px 10px 20px 0; font-weight: 500; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5;color: #{{ $company->brand_color }};"
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $contactUsRequest->itDevicesList }}</td>
                                                                            </tr>
                                                                        </tbody>
                                                                        <tbody>
                                                                            <tr>
