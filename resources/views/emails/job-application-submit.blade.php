...
<body
    ...
    <div
        ...
        Job Application - {{ $jobApplicationRequest->position }}.
    </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font"
                                                                    ...
                                                                    valign="top">Hi Team,<br><br>Here's the job application details for the {{ $jobApplicationRequest->position }} position.<br>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    ...
                                                                                    {{ $jobApplicationRequest->firstName }}</td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">
                                                                                    {{ $jobApplicationRequest->lastName }}</td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $jobApplicationRequest->email }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $jobApplicationRequest->phone }}
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                        <tbody>
