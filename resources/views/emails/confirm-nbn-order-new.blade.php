...
<html lang="en">
    ...
    <![endif]-->
        ...
        <div
            role="article"
            aria-label="An email from Your Brand Name"
            lang="en"
            style="
        ...
        >
            ...
            <header>
                ...
                <a href="https://www.medihuanna.com">
                    <img
                        src="https://www.metwide.com.au/img/email/MWC-logo.png"
                        alt="Medihuanna Logo"
                        height="90"
                        width="90"
                    />
                ...
                <h1
                    ...
                    "
                >
                    ACCREDITED MEDICINAL CANNABIS CURRICULUM: CREATED BY DOCTORS
                    FOR DOCTORS
                </h1>
            </header>
            ...
            <main>
                ...
                <!-- Body copy -->
                <p>
                    <strong>Be Ready For Medicinal Cannabis. </strong
                    ><br /><br />The day of prescribing medicinal cannabis will
                    soon become a daily part of the way we all practice. As a
                    doctor, I wanted to create a convenient, affordable,
                    accredited educational curriculum that the entire healthcare
                    community could embrace.<br /><br /><strong
                        >Be the trusted expert.</strong
                    ><br /><br />Through our remote medicinal cannabis
                    curriculum, you can quickly acquire the science-based
                    knowledge you need to always be the expert in the room. The
                    one who patients can trust to separate fact from fiction.<br /><br /><strong
                        >You're invited.</strong
                    ><br /><br />I would love you to join my online workshop on
                    <a
                        style="color: #b200fd; text-decoration: underline"
                        href="https://www.medihuanna.com/learn/workshop/34"
                        >November 6</a
                    >
                    to learn the skills needed to safely and confidently
                    prescribe medicinal cannabis. <br /><br />I believe It's
                    important for the health of your patients. And the future
                    health of your practice.<br /><a
                        style="color: #b200fd; text-decoration: underline"
                        href="https://www.medihuanna.com/learn/workshop/34"
                        ><br />Learn More</a
                    >
                ...
                <p>
                    <img
                        src="https://content.app-us1.com/B4dv3/2021/10/06/16d1b5f2-d71b-4d45-aea1-b2792b145752.png"
                        height="80"
                        width="143"
                        alt="Teresa Towpik Signature"
                    />
                </p>
                <table
                    role="presentation"
                                ...
                                >
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img
                                                    src="https://content.app-us1.com/B4dv3/2021/10/06/3bfe9dcf-f56f-40a9-add1-12c43b368108.png"
                                                    height="110"
                                                    width="110"
                                                    alt="Teresa Towpik Picture"
                                                />
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                >
                                    <tbody>
                                        ...
                                        >
                                            ...
                                            >
                                                <p>
                                                    Dr. Teresa Towpik <br />Founder,
                                                    <a
                                                        style="
                                                            color: #b200fd;
                                                            text-decoration: underline;
                                                        "
                                                        href="https://www.medihuanna.com/"
                                                        >Medihuanna</a
                                                    >
                                                </p>
                                            </td>
            ...
            <footer>
                ...
                >
                    ...
                    Medihuanna.com. Don't worry,
                    <a
                        style="color: #b200fd; text-decoration: underline"
                        href="%UNSUBSCRIBELINK%"
                        >you can unsubscribe here</a
                    >.
                </p>
                ...
                <address
                    ...
                    "
                >
                    <strong>Your Friends:</strong> Cannatrek, Balaclava 3183 VIC
                    Australia
                </address>
            </footer>
        </div>
