...
<body
    ...
    <div
        ...
        Website enquiry - {{ config('services.site.name') }}.
    </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font"
                                                                    ...
                                                                    valign="top">Hi Team,<br><br>Here's the website enquiry details.<br>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->email }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->phone }}
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->state }}</td>
                                                                            </tr>

                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="width: 280px; padding: 20px 10px 20px 0; font-weight: 500; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5;color: #{{ $company->brand_color }};"
                                                                                    valign="top">Property Type:
                                                                                </td>

                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">
                                                                                    {{ $websiteEnquiry->property_type }}</td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->best_time_to_call }}</td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->current_customer === true ? 'Yes' : 'No'}}</td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="width: 280px; padding: 20px 10px 20px 0; font-weight: 500; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5;color: #{{ $company->brand_color }};"
                                                                                    valign="top">Enquiry  Type:
                                                                                </td>

                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->enquiry_type }}</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="pc-fb-font"
                                                                                    style="width: 280px; padding: 20px 10px 20px 0; font-weight: 500; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5;color: #{{ $company->brand_color }};"
                                                                                    valign="top">Enquiry Message:
                                                                                </td>

                                                                                <td class="pc-fb-font"
                                                                                    style="padding: 20px 0; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; border-bottom: 1px solid #E5E5E5; color: #151515;"
                                                                                    valign="top" align="left">{{ $websiteEnquiry->enquiry_message }}</td>
                                                                            </tr>
                                                                        </tbody>
                                                                        <tbody>
                                                                            <tr>
