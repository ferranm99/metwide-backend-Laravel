...
class WDProjectPlannerRequestMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($fromEmail, $siteName)
            ->view('emails.wd-project-planner-request')->subject('MWC - Weebsite Design project planner request - ' . config('services.site.name'));
    }
}
