...
class BuildYourServerRequestMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($fromEmail, $siteName)
            ->view('emails.build-your-server-request')->subject('MWC - Weebsite Design project planner request - ' . config('services.site.name'));
    }
}
