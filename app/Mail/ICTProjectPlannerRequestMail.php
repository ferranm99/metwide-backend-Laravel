...
class ICTProjectPlannerRequestMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($fromEmail, $siteName)
            ->view('emails.ict-project-planner-request')->subject('MWC - ICT project planner request - ' . config('services.site.name'));
    }
}
