...
class MTVProjectPlannerRequestMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($fromEmail, $siteName)
            ->view('emails.mtv-project-planner-request')->subject('MWC - Microsoft Teams Voice project planner request - ' . config('services.site.name'));
    }
}
